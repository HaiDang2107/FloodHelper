  ...
  const campaigns = [
    {
      ...
      state: 'DONATING',
      startedDonationAt: new Date('2026-04-01T08:00:00Z'),
      finishedDonationAt: new Date('2026-04-15T18:00:00Z'),
    },
    {
      ...
      state: 'DISTRIBUTING',
      startedDonationAt: new Date('2026-03-01T08:00:00Z'),
      finishedDonationAt: new Date('2026-03-25T18:00:00Z'),
      startedDistributionAt: new Date('2026-04-01T08:00:00Z'),
    },
    {
      ...
      state: 'FINISHED',
      startedDonationAt: new Date('2026-01-10T08:00:00Z'),
      finishedDonationAt: new Date('2026-02-10T18:00:00Z'),
      startedDistributionAt: new Date('2026-02-15T08:00:00Z'),
      finishedDistributionAt: new Date('2026-03-30T18:00:00Z'),
    },
    {
      ...
      state: 'DONATING',
      startedDonationAt: new Date('2026-04-05T08:00:00Z'),
      finishedDonationAt: new Date('2026-05-05T18:00:00Z'),
    },
  ];
