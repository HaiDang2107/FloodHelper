...
extension UserProfileToDataMapper on UserProfile {
  data.UpdateProfileDto toUpdateDto() {
    return data.UpdateProfileDto(
      ...
      originProvinceCode: address?.originProvinceCode,
      originProvinceName: address?.originProvinceName,
      originWardCode: address?.originWardCode,
      originWardName: address?.originWardName,
      residenceProvinceCode: address?.residenceProvinceCode,
      residenceProvinceName: address?.residenceProvinceName,
      residenceWardCode: address?.residenceWardCode,
      residenceWardName: address?.residenceWardName,
